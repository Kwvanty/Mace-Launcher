    ...
    with app.app_context():
        ...
        if cursor.fetchone()[0] == 0:
            initial_updates = [
                ...
                ('1.0.4', 'Mace Launcher comes with Python already built in, so you don't need to install or configure it manually. Just install the launcher and start using it.', 'Mace Launcher уже содержит встроенный Python, поэтому вам не нужно устанавливать или настраивать его вручную. Просто установите лаунчер и начинайте пользоваться им.', 'Mace Launcher вже містить вбудований Python, тому вам не потрібно встановлювати або налаштовувати його вручну. Просто встановіть лаунчер і починайте користуватися ним.')
            ]
